 ...
 * @version $Id: config_gedcom.php 2839 2008-04-13 16:48:19Z fisharebest $
 */
...
$PEDIGREE_ROOT_ID = "I6";				// -- use this line to change the default person who appears on
										// -- the Pedigree tree
...
$GEDCOM_DEFAULT_TAB = "-1";				//-- this setting controls which tab on the individual page should first be displayed to visitors

$SHOW_CONTEXT_HELP = true;				// show ? links on the page for contextual popup help
$PHPGEDVIEW_EMAIL = "phpgedview-noreply@franz-family.org";		    		// -- "From:" address for automatically generated e-mails
$CONTACT_EMAIL = "kalefranz";		    // -- this is who the user should contact for more information
$CONTACT_METHOD = "messaging2";						// -- the method to allow users to contact you. options are: mailto, messaging, messaging2
$WEBMASTER_EMAIL = "kalefranz";		// -- this is who the user should contact in case of errors
$SUPPORT_METHOD = "messaging2";						// -- the method to allow users to contact you. options are: mailto, messaging, messaging2
$HOME_SITE_URL = "http://wiki.phpgedview.net/en/index.php?title=Users_Guide";     // -- url for your home page
...
$COMMON_NAMES_THRESHOLD = "20";		//-- The minimum number of times a surname must appear before it is shown on the most common surnames list
...
$META_TITLE = "Franz Family";			//-- optional text that can be added to the html page <title></title> line
