...
$DBUSER = "kfranz_geduser";									//-- MySQL database User Name
$DBPASS = "odwalla10";									//-- MySQL database User Password
$DBNAME = "kfranz_phpgedview";							//-- The MySQL database name where you want PHPGedView to build its tables
...
$SERVER_URL = "http://www.franz-family.org/genealogy/";								//-- the URL used to access this server
...
$PGV_MEMORY_LIMIT = "300M";						//-- the maximum amount of memory that PGV should be allowed to consume
...
define('PGV_GOOGLE_ANALYTICS', 'UA-3187139-4');